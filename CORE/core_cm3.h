 ...
 * .
 *   - Error 528: \n
 *     static __inline__ void NVIC_DisableIRQ(uint32_t IRQn) \n
 ...
 ******************************************************************************/
  ...
  #define __inline__        inline                                      /*!< inline keyword for IAR Compiler. Only avaiable in High optimization mode! */
 ...
 * Return the content of the base priority register
 */
static __inline__ uint32_t  __get_BASEPRI(void)
{
  register uint32_t __regBasePri         __ASM("basepri");
  return(__regBasePri);
}
 ...
 * Set the base priority register
 */
static __inline__ void __set_BASEPRI(uint32_t basePri)
{
  register uint32_t __regBasePri         __ASM("basepri");
 ...
 * Return the content of the fault mask register
 */
static __inline__ uint32_t __get_FAULTMASK(void)
{
 ...
 * Set the fault mask register
 */
static __inline__ void __set_FAULTMASK(uint32_t faultMask)
{
  register uint32_t __regFaultMask       __ASM("faultmask");
 ...
 * Return the content of the control register
 */
static __inline__ uint32_t __get_CONTROL(void)
{
 ...
 * Set the control register
 */
static __inline__ void __set_CONTROL(uint32_t control)
{
  register uint32_t __regControl         __ASM("control");
...
static __inline__ void __enable_fault_irq()         { __ASM ("cpsie f"); }
static __inline__ void __disable_fault_irq()        { __ASM ("cpsid f"); }

#define __NOP                                     __no_operation            /*!< no operation intrinsic in IAR Compiler */ 
static __inline__  void __WFI()                     { __ASM ("wfi"); }
static __inline__  void __WFE()                     { __ASM ("wfe"); }
static __inline__  void __SEV()                     { __ASM ("sev"); }
static __inline__  void __CLREX()                   { __ASM ("clrex"); }

/* intrinsic void __ISB(void)                                     */
/* intrinsic void __DSB__(void)                                     */
...
static __inline__ void __enable_irq()               { __ASM volatile ("cpsie i"); }
static __inline__ void __disable_irq()              { __ASM volatile ("cpsid i"); }

static __inline__ void __enable_fault_irq()         { __ASM volatile ("cpsie f"); }
static __inline__ void __disable_fault_irq()        { __ASM volatile ("cpsid f"); }

static __inline__ void __NOP()                      { __ASM volatile ("nop"); }
static __inline__ void __WFI()                      { __ASM volatile ("wfi"); }
static __inline__ void __WFE()                      { __ASM volatile ("wfe"); }
static __inline__ void __SEV()                      { __ASM volatile ("sev"); }
static __inline__ void __ISB()                      { __ASM volatile ("isb"); }
static __inline__ void __DSB__()                      { __ASM volatile ("dsb"); }
static __inline__ void __DMB()                      { __ASM volatile ("dmb"); }
static __inline__ void __CLREX()                    { __ASM volatile ("clrex"); }
 ...
 */
static __inline__ void NVIC_SetPriorityGrouping(uint32_t PriorityGroup)
{
  uint32_t reg_value;
 ...
 */
static __inline__  uint32_t NVIC_GetPriorityGrouping(void)
{
 ...
 */
static __inline__  void NVIC_EnableIRQ(IRQn_Type IRQn)
{
 ...
 * The interrupt number cannot be a negative value.
 */
static __inline__ void NVIC_DisableIRQ(IRQn_Type IRQn)
{
 ...
 */
static __inline__ uint32_t NVIC_GetPendingIRQ(IRQn_Type IRQn)
{
 ...
 * The interrupt number cannot be a negative value.
 */
static __inline__ void NVIC_SetPendingIRQ(IRQn_Type IRQn)
{
 ...
 * The interrupt number cannot be a negative value.
 */
static __inline__ void NVIC_ClearPendingIRQ(IRQn_Type IRQn)
{
 ...
 * otherwise it returns 0.
 */
static __inline__ uint32_t NVIC_GetActive(IRQn_Type IRQn)
{
 ...
 */
static __inline__ void NVIC_SetPriority(IRQn_Type IRQn, uint32_t priority)
{
  if(IRQn < 0) {
 ...
 * Note: The priority cannot be set for every core interrupt.
 */
static __inline__ uint32_t NVIC_GetPriority(IRQn_Type IRQn)
{
 ...
 */
static __inline__ uint32_t NVIC_EncodePriority (uint32_t PriorityGroup, uint32_t PreemptPriority, uint32_t SubPriority)
{
  uint32_t PriorityGroupTmp = (PriorityGroup & 0x07);          /* only values 0..7 are used          */
 ...
 */
static __inline__ void NVIC_DecodePriority (uint32_t Priority, uint32_t PriorityGroup, uint32_t* pPreemptPriority, uint32_t* pSubPriority)
{
  uint32_t PriorityGroupTmp = (PriorityGroup & 0x07);          /* only values 0..7 are used          */
  uint32_t PreemptPriorityBits;
  uint32_t SubPriorityBits;
 ...
 */
static __inline__ uint32_t SysTick_Config(uint32_t ticks)
{ 
...
static __inline__ void NVIC_SystemReset(void)
{
  ...
  __DSB__();                                                     /* Ensure completion of memory access */              
 ...
 */
static __inline__ uint32_t ITM_SendChar (uint32_t ch)
{
 ...
 * It is blocking when a debugger is connected, but the previous character send is not transmitted. 
 */
static __inline__ int ITM_ReceiveChar (void) {
 ...
 */
static __inline__ int ITM_CheckChar (void) {
